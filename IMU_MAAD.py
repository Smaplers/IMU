...
# Paths
DATA_ROOT = r"D:\Clip_MU\Minimal Clip Path-level Machine Unlearning\data_MAAD"

FORGET_DIR = os.path.join(DATA_ROOT, "forget_identity/person_A")
ATTR_DIR   = os.path.join(DATA_ROOT, "attribute_matched")
RETAIN_DIR = os.path.join(DATA_ROOT, "retain")

FT_VISUAL_PATH = r"./outputs_maad_ft/clip_maad_visual.pth"
OUT_PATH = r"./\MU_MAAD/IMU/IMU_MAAD.pth"
...
def repel_total_scale(step, total_steps):
    # 前 10% step 弱化 Repel，让 RS 先建立主导方向
    warmup = int(0.1 * total_steps)
    ramp = int(0.16 * total_steps)
